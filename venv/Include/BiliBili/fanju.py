...
def get_play_list(aid, cid, quality):
    ...
    headers = {
        ...
        'Cookie': 'SESSDATA=d74b3ee3%2C1578232065%2C5b9d3fc1',  # 登录B站后复制一下cookie中的SESSDATA字段,有效期1个月
...
if __name__ == '__main__':
    ...
    # currentVideoPath = os.path.join(sys.path[0], 'G:/shiyue/bilibili_video')  # 当前目录作为下载目录
